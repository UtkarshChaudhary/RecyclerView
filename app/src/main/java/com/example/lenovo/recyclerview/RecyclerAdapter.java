...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.NoteViewHolder> {
    ...
    public RecyclerAdapter(Context mContext, ArrayList<Note> mNotes, NotesClickListener mListener) {
    ...
    public static class NoteViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public NoteViewHolder(View itemView, NotesClickListener mNotesClickListener) {
            super(itemView);
            itemView.setOnClickListener(this);
            this.mNotesClickListener = mNotesClickListener;
